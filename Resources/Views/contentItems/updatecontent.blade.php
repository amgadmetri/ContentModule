...
<div class="container">
   ...
   <form method="post">
    ...
    <div class="form-group">
      ...
      class="form-control" 
      name="title" 
      value="{{ $contentItem->contentLanguagesVars->first()->title }}" 
    ...
    <div class="form-group">
      ...
      class="form-control" 
      name="description" 
      value="{{ $contentItem->contentLanguagesVars->first()->description }}" 
    ...
    <div class="form-group">
      ...
      value="" 
      placeholder="Content Description .." 
      aria-describedby="sizing-addon2">{{ $contentItem->contentLanguagesVars->first()->content }}</textarea>
    </div>
